...
class fpu_coverage extends uvm_component;
    ...
    virtual function void build_phase(uvm_phase phase);
        ...
        // --------------------------------------------------------
        // Initialize all functional coverage bins explicitly.
        // This ensures that report_phase() prints zero-hit bins too.
        // --------------------------------------------------------
        ...
        // Operand A architectural categories
        ...
        // Operand B architectural categories
        ...
        // Result architectural categories
        ...
        // Exponent regions for operand A
        ...
        // Exponent regions for operand B
