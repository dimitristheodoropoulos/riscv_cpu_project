...
package cpu_env_pkg;
    ...
    // Connections:
    //
    //   driver.ap -> scoreboard.expected_export
    //   monitor.analysis_port -> scoreboard.observed_export
    //
    // The environment itself performs no DUT hierarchy access.
    // ------------------------------------------------------------
    ...
    class cpu_env extends uvm_env;
        ...
        function void connect_phase(uvm_phase phase);
            ...
            // ----------------------------------------------------
            // Observed architectural state -> scoreboard
            // ----------------------------------------------------
